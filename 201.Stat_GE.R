...
model1 <- fixest::feglm(data=events_sum, count~sw(value,gws_avg1,gws_avg5,gws_avg10, gws_growth1, gws_growth5, gws_growth10)|region + year, family=quasipoisson)
model2 <- fixest::feglm(data=events_sum, count~sw(gws_anomalies,gws_std1, gws_std5,gws_std10)|region + year, family=quasipoisson)
