...
setFixest_dict(c(conflicts="number of conflicts per type", value="gws [g/m^3]",
...
print(table_africa, caption = "Total Conflicts", caption.placement = "top", file = "^Tables/glm_conflicts_africa.txt", include.rownames = FALSE)
...
print(table_asia, caption = "Total Conflicts", caption.placement = "top", file = "^Tables/glm_conflicts_asia.txt", include.rownames = FALSE)
...
print(table_oceania, caption = "Total Conflicts", caption.placement = "top", file = "^Tables/glm_conflicts_oceania.txt", include.rownames = FALSE)
...
print(table_europe, caption = "Total Conflicts", caption.placement = "top", file = "^Tables/glm_conflicts_europe.txt", include.rownames = FALSE)
...
print(table_Namerica, caption = "Total Conflicts", caption.placement = "top", file = "^Tables/glm_conflicts_Namerica.txt", include.rownames = FALSE)
...
print(table_Samerica, caption = "Total Conflicts", caption.placement = "top", file = "^Tables/glm_conflicts_Samerica.txt", include.rownames = FALSE)
...
print(table_Camerica, caption = "Total Conflicts", caption.placement = "top", file = "^Tables/glm_conflicts_Camerica.txt", include.rownames = FALSE)
