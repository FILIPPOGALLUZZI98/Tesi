...
Africa <- fixest::feols(data=data_1, log(migrants)~sw(value,gws_avg1,gws_avg5,gws_avg10, gws_anomalies, gws_std1, gws_std5,gws_std10, gws_growth1, gws_growth5, gws_growth10)|region + year)
table_africa <- etable(Africa, tex=TRUE)
write.table(table_africa, file = "^Tables/glm_migration_africa.txt", sep = "\t", quote = FALSE, row.names = FALSE)
...
data_continent <- data_1 %>%
  filter(get_continent(country) == continent)
Asia <- fixest::feols(data=data_1, log(migrants)~sw(value,gws_avg1,gws_avg5,gws_avg10, gws_anomalies, gws_std1, gws_std5,gws_std10, gws_growth1, gws_growth5, gws_growth10)|region + year)
table_asia <- etable(Asia, tex=TRUE)
write.table(table_asia, file = "^Tables/glm_migration_asia.txt", sep = "\t", quote = FALSE, row.names = FALSE)
...
data_continent <- data_1 %>%
  filter(get_continent(country) == continent)
Oceania <- fixest::feols(data=data_1, log(migrants)~sw(value,gws_avg1,gws_avg5,gws_avg10, gws_anomalies, gws_std1, gws_std5,gws_std10, gws_growth1, gws_growth5, gws_growth10)|region + year)
table_oceania <- etable(Oceania, tex=TRUE)
write.table(table_oceania, file = "^Tables/glm_migration_oceania.txt", sep = "\t", quote = FALSE, row.names = FALSE)
...
data_continent <- data_1 %>%
  filter(get_continent(country) == continent)
Europe <- fixest::feols(data=data_1, log(migrants)~sw(value,gws_avg1,gws_avg5,gws_avg10, gws_anomalies, gws_std1, gws_std5,gws_std10, gws_growth1, gws_growth5, gws_growth10)|region + year)
table_europe <- etable(Europe, tex=TRUE)
write.table(table_europe, file = "^Tables/glm_migration_europe.txt", sep = "\t", quote = FALSE, row.names = FALSE)

North_America <- c("United States", "Canada", "Mexico")
N_A <- data_1[data_1$country %in% North_America, ]
Namerica <- fixest::feols(data=data_1, log(migrants)~sw(value,gws_avg1,gws_avg5,gws_avg10, gws_anomalies, gws_std1, gws_std5,gws_std10, gws_growth1, gws_growth5, gws_growth10)|region + year)
table_Namerica <- etable(Namerica, tex=TRUE)
write.table(table_Namerica, file = "^Tables/glm_migration_Namerica.txt", sep = "\t", quote = FALSE, row.names = FALSE)
...
Samerica <- fixest::feols(data=data_1, log(migrants)~sw(value,gws_avg1,gws_avg5,gws_avg10, gws_anomalies, gws_std1, gws_std5,gws_std10, gws_growth1, gws_growth5, gws_growth10)|region + year)
table_Samerica <- etable(Samerica, tex=TRUE)
write.table(table_Samerica, file = "^Tables/glm_migration_Samerica.txt", sep = "\t", quote = FALSE, row.names = FALSE)
...
Camerica <- fixest::feols(data=data_1, log(migrants)~sw(value,gws_avg1,gws_avg5,gws_avg10, gws_anomalies, gws_std1, gws_std5,gws_std10, gws_growth1, gws_growth5, gws_growth10)|region + year)
table_Camerica <- etable(Camerica, tex=TRUE)
write.table(table_Camerica, file = "^Tables/glm_migration_Camerica.txt", sep = "\t", quote = FALSE, row.names = FALSE)
